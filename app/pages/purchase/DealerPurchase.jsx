    ...
    <div className="min-h-screen bg-slate-50/50 text-slate-900 font-sans antialiased">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium -mt-0.5">Dealer Purchase</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h2 className="text-xs font-bold uppercase tracking-widest text-slate-400">Dealer Purchase Records</h2>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200">
                    {["#", "Dealer Name", "Father Name", "CNIC", "Phone", "Bike", "CC", "Color", "Reg. No", "Chasis No", "Engine No", "Actual Amount", "Remaining", "Extra Expense", "Date", "Approval", "Actions"].map((h) => (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-200">
              <h2 className="text-lg font-bold text-slate-900">{isViewOnly ? "View Dealer Purchase Record" : (editId ? "Edit" : "Add") + " Dealer Purchase"}</h2>
            ...
            <form onSubmit={handleSubmit} className="px-6 py-5 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { name: "customerName", label: "Dealer Name", type: "text", required: true },
